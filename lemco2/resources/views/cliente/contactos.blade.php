...
<body>
    <div class="container">
        ...
        <div class="card col-sm-12">
            <div class="card-body">
            <form action="{{ route('contacto.store',$id) }}" method="post">
                @csrf
                    <h2 class="text-center h1_cus mt-4 mb-4">7. DATOS DE CONTACTOS </h2>
                    <p class="label-cus">INFORMACIÓN PARA ENVÍO DE FACTURACIÓN ELECTRÓNICA *</p>

                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                        <label class="label-cus" for="CorreoFE">Correo recepción facturación*</label>
                        <input type="text" class="form-control" id="CorreoFE" name="CorreoFE" >
                            @if ($errors->has('CorreoFE'))
                                <p class="text-danger">{{ $errors->first('CorreoFE') }}</p>
                            @endif
                        </div>
                        <div class="form-group">
                        <label class="label-cus" for="NombreFE">Nombre contacto principal*</label>
                        <input type="text" class="form-control" id="NombreFE" name="NombreFE" >
                            @if ($errors->has('NombreFE'))
                                <p class="text-danger">{{ $errors->first('NombreFE') }}</p>
                            @endif
                        </div>
                        <div class="form-group">
                        <label class="label-cus" for="TelefonoFE">Teléfono*</label>
                        <input type="text" class="form-control" id="TelefonoFE" name="TelefonoFE" >
                            @if ($errors->has('TelefonoFE'))
                                <p class="text-danger">{{ $errors->first('TelefonoFE') }}</p>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        <label class="label-cus" for="CargoFE">Cargo*</label>
                        <input type="text" class="form-control" id="CargoFE" name="CargoFE" >
                        @if ($errors->has('CargoFE'))
                         <p class="text-danger">{{ $errors->first('CargoFE') }}</p>
                        @endif
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <label class="label-cus" for="FechaCierre">Fecha de cierre (opcional)*</label>
                        <input type="date" class="form-control" id="FechaCierre" name="FechaCierre" >
                        @if ($errors->has('FechaCierre'))
                         <p class="text-danger">{{ $errors->first('FechaCierre') }}</p>
                        @endif
                        </div>
                    </div>
                    </div>
